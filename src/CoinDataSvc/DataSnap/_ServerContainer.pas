...
uses System.SysUtils, System.Classes,
  ...
  IPPeerServer, Registry, Winapi.Windows, cdOption,
...
type
  TServerContainer = class(TService)
    ...
    procedure dsDataLoaderGetClass(DSServerClass: TDSServerClass;
      var PersistentClass: TPersistentClass);
  private
...
uses _smDataProvider, JdcGlobal, cdGlobal, JdcGlobal.DSCommon;
...
procedure TServerContainer.dsDataLoaderGetClass(DSServerClass: TDSServerClass;
  var PersistentClass: TPersistentClass);
begin
  PersistentClass := _smDataLoader.TsmDataLoader;
end;
